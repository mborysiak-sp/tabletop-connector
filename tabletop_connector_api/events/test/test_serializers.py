...
class AddressCreateSerializerTest(TestCase):
    ...
    def test_serializer_with_invalid_address(self):
        self.assertRaises(serializers.ValidationError,
                          self.address_create_serializer.create, self.invalid_address)
...
class AddressSerializerTest(TestCase):
    ...
    def test_update_valid_data(self):
        ...
        assert self.address_serializer.update(instance=address,
                                              validated_data=self.valid_address) is not None
